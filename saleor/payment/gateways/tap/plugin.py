...
class TapGatewayPlugin(BasePlugin):
    PLUGIN_ID = "mirumee.payments.tap"
    PLUGIN_NAME = GATEWAY_NAME
    DEFAULT_ACTIVE = True
    DEFAULT_CONFIGURATION = [
        {"name": "Public API key", "value": None},
        {"name": "Secret API key", "value": "sk_test_QVJqnjM3aEAu4mi65bYPtgFl"},
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.config = GatewayConfig(
            ...
            auto_capture=configuration["Automatic payment capture"],
             connection_params={
                "public_key": "pk_test_YIot2mCfveUZ8RT9z34gbNEl",
                "private_key": "sk_test_QVJqnjM3aEAu4mi65bYPtgFl",
            },
